...
import "./styles.css";
>>>>>>> 82e2d55643f960582896f484b815e08dceef5d25
...
function ProfilePage() {
  ...
  const sendButton =
    '<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"width="20px" height="20px" viewBox="0 0 535.5 535.5" style="enable-background:new 0 0 535.5 535.5;" xml:space="preserve" fill="purple"><g><g id="send"><polygon points="0,497.25 535.5,267.75 0,38.25 0,216.75 382.5,267.75 0,318.75"/></g></g><g></svg>';
  const [showMessages, setShowMessages] = useState(false);
  const showHideClassName = showMessages
    ? "messages-modal display-block"
    : "messages-modal display-none";
  function hideModal() {
    ...
    <>
      <div className="profile-container">
        <div className="leaderboard-container">
          <p className="container-title">Leaderboard</p>
          {<LeaderBoard />}
        </div>
